...
TEXTO BILINGÜE (tipo_rotor, tipo_generador, cimentacion_requerida): estos 3
campos -- los únicos de esta ficha que la app hoy muestra en pantalla -- NO
guardan el texto en español directo. Guardan la CLAVE de traducción
(engine/i18n.py, sección "Fichas técnicas de turbinas") que hay que resolver
con t()/tr() antes de mostrarla -- así el mismo dato sirve para el toggle
ES/EN y para el informe PDF sin duplicar la ficha completa en dos idiomas.
Los otros 3 campos de texto (sistema_frenado, material_palas,
material_chasis) siguen en español plano porque todavía no se despliegan en
ningún lado -- conectarlos a algún lugar visible es el momento de pasarlos
también por el mismo patrón.
...
SPECS_TURBINAS = {
    "small_tulip": {
        ...
        "tipo_rotor": "specs_small_tulip_rotor",
        ...
        "tipo_generador": "specs_small_tulip_generador",
        "polos_generador": 8,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_small_tulip_cimentacion",
        "costo_usd": 1153.36,
    ...
    "survival_unit": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_survival_unit_rotor",
        "potencia_nominal_w": 100,
        "viento_potencia_nominal_ms": 14.5,
        "produccion_12ms_aislada_w": 62.2,
        ...
        "tipo_generador": "specs_survival_unit_generador",
        "polos_generador": 8,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_survival_unit_cimentacion",
        "costo_usd": None,
    },
    "medium_tulip": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_medium_tulip_rotor",
        ...
        "tipo_generador": "specs_medium_tulip_generador",
        "polos_generador": 18,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_medium_tulip_cimentacion",
        "costo_usd": 9349.26,
        "costo_usd_fuente": "verificado",
    },
    "three_m_tulip": {
        ...
        "vida_diseno_anos": 20,
        "cimentacion_requerida": "specs_three_m_tulip_cimentacion",
        "costo_usd": 12905.75,
        "costo_usd_fuente": "verificado",
    },
    "large_tulip": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_large_tulip_rotor",
        ...
        "tipo_generador": "specs_large_tulip_generador",
        "polos_generador": 24,
        ...
        "vida_diseno_anos": 20,
        "cimentacion_requerida": "specs_large_tulip_cimentacion",
        "costo_usd": 24700.00,
    ...
    "al13_2m": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_al13_2m_rotor",
        "potencia_nominal_w": 1000,
        ...
        "tipo_generador": "specs_al13_2m_generador",
        "polos_generador": 18,
        ...
        "vida_diseno_anos": 20,
        "cimentacion_requerida": "specs_al13_2m_cimentacion",
        "costo_usd": 8929.05,
        "costo_usd_fuente": "verificado",
    },
    "al13_6m": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_al13_6m_rotor",
        "potencia_nominal_w": 5000,
        "viento_potencia_nominal_ms": 12.0,
        ...
        "velocidad_supervivencia_ms": 54.0,
        "sistema_frenado": "Electrónico + Freno mecánico",
        "tipo_generador": "specs_al13_6m_generador",
        "polos_generador": 24,
        ...
        "vida_diseno_anos": 20,
        "cimentacion_requerida": "specs_al13_6m_cimentacion",
        "costo_usd": 20215.00,
        "costo_usd_fuente": "no_verificado",
    },
    "al13_8m": {
        ...
        "clase_iec": "IEC 61400 Class IV",
        "tipo_rotor": "specs_al13_8m_rotor",
        ...
        "velocidad_supervivencia_ms": 54.0,
        "sistema_frenado": "Electrónico + Freno mecánico",
        "tipo_generador": "specs_al13_8m_generador",
        "polos_generador": 24,
        ...
        "vida_diseno_anos": 20,
        "cimentacion_requerida": "specs_al13_8m_cimentacion",
        "costo_usd": 25545.00,
        "costo_usd_fuente": "no_verificado",
    },
    "ecoroof_flat_3": {
        ...
        "clase_iec": "N/A",
        "tipo_rotor": "specs_ecoroof_flat_3_rotor",
        ...
        "tipo_generador": "specs_ecoroof_flat_3_generador",
        "polos_generador": 8,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_ecoroof_flat_3_cimentacion",
        "costo_usd": 9295.00,
        "costo_usd_fuente": "no_verificado",
    },
    "ecoroof_flat_5": {
        ...
        "clase_iec": "N/A",
        "tipo_rotor": "specs_ecoroof_flat_5_rotor",
        "potencia_nominal_w": 500,
        "viento_potencia_nominal_ms": 14.5,
        "produccion_12ms_aislada_w": None,
        "produccion_12ms_cluster5_total_w": None,
        ...
        "velocidad_supervivencia_ms": 54.0,
        "sistema_frenado": "Electrónico automático",
        "tipo_generador": "specs_ecoroof_flat_5_generador",
        "polos_generador": 8,
        "voltaje_salida": "Controladores híbridos o separados",
        "altura_total_m": None,
        "altura_pala_m": 1.149,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_ecoroof_flat_5_cimentacion",
        "costo_usd": 12545.00,
        "costo_usd_fuente": "no_verificado",
    },
    "ecoroof_slanted": {
        ...
        "clase_iec": "N/A",
        "tipo_rotor": "specs_ecoroof_slanted_rotor",
        "potencia_nominal_w": 300,
        "viento_potencia_nominal_ms": 14.5,
        "produccion_12ms_aislada_w": None,
        "produccion_12ms_cluster5_total_w": None,
        ...
        "velocidad_supervivencia_ms": 54.0,
        "sistema_frenado": "Electrónico automático",
        "tipo_generador": "specs_ecoroof_slanted_generador",
        "polos_generador": 8,
        ...
        "vida_diseno_anos": 40,
        "cimentacion_requerida": "specs_ecoroof_slanted_cimentacion",
        "costo_usd": None,
    },
}
